...
// Non-changing, hydration-safe particle configurations
const STATIC_GOLD_DOTS = [
  ...
  { id: 15, top: "28%", left: "28%", size: "6px", duration: "10s", delay: "0.4" }
];
...
export default function Hero({ id = "hero" }: SectionProps) {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      // Gentle parallax shift relative to center screen
  ...
  return (
    ...
    >
      ...
      {/* BACKGROUND GRAPHICS & RADIAL LIGHT SWEEPS */}
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-4xl">
          ...
          >
            <Link
              href="#contact"
              id="hero_cta_book"
              className="px-8 py-3.5 sm:py-4 bg-[#C9A84C] hover:bg-[#E8C97A] text-[#0a0a0a] font-sans font-semibold tracking-widest text-xs uppercase rounded transition-colors shadow-lg shadow-[#C9A84C]/15 flex items-center justify-center gap-2 font-medium"
            >
            ...
            <Link
              href="#services"
              id="hero_cta_work"
              className="px-8 py-3.5 sm:py-4 border border-[#C9A84C]/60 hover:border-[#C9A84C] text-[#F5F0E8] hover:bg-white/[0.03] font-sans font-semibold tracking-widest text-xs uppercase rounded transition-all flex items-center justify-center gap-2"
            >
